...
public class BuildVars {
    ...
    public static final String INTERNALWEBHOOKURL = "http://localhost:" + PORT; // https://(xyz.)localip/domain(.tld)
    ...
    public static final String linkDB = "jdbc:mysql://localhost:3306/xiaok168db?useUnicode=true&characterEncoding=UTF-8";
